...
auto solve_case()
{
  ...
  for (size_t i{}; i != q; ++i) {
    size_t l, r;
    cin >> l >> r;
    long long breaking{static_cast<long long>(s[l] == '1' && s[l - 1] == '1')
                       + static_cast<long long>(s[r] == '1' && s[r + 1] == '1')};
    long long connecting{static_cast<long long>(s[l] == '1' && s[r + 1] == '1')
                         + static_cast<long long>(s[r] == '1' && s[l - 1] == '1')};
    long long delta{breaking - connecting};
    cout << cnt + delta << endl;
  }
}
