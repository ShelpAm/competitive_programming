...
// Problem: A - CBC
// Contest: Tokio Marine & Nichido Fire Insurance Programming Contest 2025
// (AtCoder Beginner Contest 402) Judge: AtCoder URL:
// https://atcoder.jp/contests/abc402/tasks/abc402_a Start: Tue 22 Apr 2025
// 03:22:30 PM CST Author: ShelpAm
...
void solve_case()
{
    std::string s;
    std::cin >> s;
    for (auto e : s | std::views::filter(isupper)) {
        std::cout << e;
    }
}
} // namespace
