...
// Memory Limit: 1024
// Time Limit: 2000
// Start: Sat 13 Jul 2024 08:05:40 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  debug("dir", dir);
  auto yes{ranges::any_of(views::iota(0, 3), [&](int i) {
    return dir[i].first * dir[(i + 1) % 3].first +
               dir[i].second * dir[(i + 1) % 3].second ==
           0;
  })};
  cout << (yes ? "Yes" : "No");
}
