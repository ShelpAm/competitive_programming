// Problem: B - Ticket Counter
// Contest: AtCoder Beginner Contest 358
// Judge: AtCoder
// URL: https://atcoder.jp/contests/abc358/tasks/abc358_b
// Memory Limit: 1024
// Time Limit: 2000
// Start: Sat 15 Jun 2024 08:02:35 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  vector<int> t(n);
  cin >> t;
  int join_time{-inf<int>};
  for (auto e : t) {
    join_time = max(join_time + a, e);
    cout << join_time + a << '\n';
  }
}
