...
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/553673/problem/J*/
/*Start: Sat 28 Sep 2024 03:49:07 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  std::map<u64, u64> _f;
  _f[0] = _f[1] = 1;
  std::function<u64(u64)> f{[&](u64 n) {
    if (_f.contains(n)) {
      return _f[n];
    }
    if (n % 2 == 0) {
      return _f[n] = 2 * f(n / 2) * f(n / 2 - 1);
    }
    return _f[n] = f(n / 2) * f(n / 2);
  }};
