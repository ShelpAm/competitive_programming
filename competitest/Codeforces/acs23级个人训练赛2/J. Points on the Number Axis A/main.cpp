...
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/555706/problem/J*/
/*Start: Sat 05 Oct 2024 03:00:39 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  std::vector<int> a(n);
  std::cin >> a;
  std::cout << sum_of(a) % mod998244353 *
                   pow(n, mod998244353 - 2, mod998244353) % mod998244353
            << '\n';
}
} // namespace
