...
/*Contest: acs23级个人训练赛2*/
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/555706/problem/B*/
/*Start: Sat 05 Oct 2024 02:47:31 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  auto area{[&](auto i, auto j, auto k) {
    auto [b, c]{a[i]};
    auto [d, e]{a[j]};
    auto [f, g]{a[k]};
    auto [x, y]{std::make_pair(b - d, c - e)};
    auto [p, q]{std::make_pair(b - f, c - g)};
    return std::abs(x * q - p * y) / 2.0;
  }};
