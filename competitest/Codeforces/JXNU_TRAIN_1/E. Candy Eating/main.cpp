/*Problem: E. Candy Eating*/
/*Contest: JXNU_TRAIN_1*/
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/552292/problem/E*/
/*Start: Tue 24 Sep 2024 02:36:29 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  for (auto [c, k] : a) {
    ...
    auto it{space.lower_bound(c)};
    if (it == space.end()) {
      --it;
    }
    space.erase(it);
    i64 const eaten{std::min(k, *it)};
    ans += eaten * c;
    space.insert(*it - eaten);
  }
  std::cout << ans << '\n';
}
} // namespace
