/*Problem: D. Nightmare on 24th*/
/*Contest: JXNU_TRAIN_1*/
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/552292/problem/D*/
/*Start: Tue 24 Sep 2024 02:22:20 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  for (auto const e : q) {
    auto x{std::ranges::lower_bound(s, e) - s.begin()};
    if (x > n) {
      std::cout << -1 << '\n';
    }
    else {
