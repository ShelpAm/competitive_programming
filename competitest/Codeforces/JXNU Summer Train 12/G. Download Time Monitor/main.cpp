...
/*Contest: JXNU Summer Train 12*/
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/542262/problem/G*/
/*Start: Sun 11 Aug 2024 07:21:41 PM CST*/
/*Author: ShelpAm*/
...
void solve_case() noexcept
{
  ...
  std::cin >> _b >> _t1 >> _a1 >> _t2 >> _a2;

  double b = _b, t1 = _t1, t2 = _t2, a1 = _a1, a2 = _a2;
  t2 -= t1;
  t1 -= t1;
  if (t2 * b >= a1) {
    std::cout << a1 / b << ' ' << a2 / b << '\n';
    ...
    a1 -= t2 * b;
    auto const co_size{std::min(a1, a2)};
    auto const co_time{co_size / (b / 2)};
    a1 -= co_size;
    a2 -= co_size;
    std::cout << t2 + co_time + a1 / b << ' ' << co_time + a2 / b << '\n';
  }
}
} // namespace
