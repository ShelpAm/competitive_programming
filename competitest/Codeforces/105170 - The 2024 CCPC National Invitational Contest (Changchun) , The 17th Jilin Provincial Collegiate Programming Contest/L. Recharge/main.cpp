// Problem: L. Recharge
// Contest: 105170 - The 2024 CCPC National Invitational Contest (Changchun) ,
// The 17th Jilin Provincial Collegiate Programming Contest Judge: Codeforces
// URL: https://codeforces.com/group/LoKuiAQTZh/contest/528736/problem/L
// Memory Limit: 512
// Time Limit: 1000
// Start: Tue 23 Jul 2024 12:31:38 AM CST
// Author: ShelpAm
...
#define int i64
  ...
  if (k % 2 == 0) {
    ...
    auto const dx{1};
    auto const dy{k / 2};
    auto const t1{min(x / dx, y / dy)};
    x -= t1 * dx;
    y -= t1 * dy;
    auto const t2{x == 0 ? y / (k / 2 + 1) : (x + 2 * y) / k};
    cout << t1 + t2 << '\n';
  }
}
} // namespace
