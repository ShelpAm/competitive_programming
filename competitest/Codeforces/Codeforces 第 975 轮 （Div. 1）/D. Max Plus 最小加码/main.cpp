/*Problem: D. Max Plus 最小加码*/
/*Contest: Codeforces 第 975 轮 （Div. 1）*/
/*Judge: Codeforces*/
/*URL: https://codeforces.com/contest/2018/problem/D*/
/*Start: Sun 29 Sep 2024 05:55:57 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  std::ranges::sort(idx, [&](auto l, auto r) { return a[l] > a[r]; });

  disjoint_set_union::Dsu d(n);

  auto for (auto const i : idx)
  {
    auto const e{a[i]};
  }
}
