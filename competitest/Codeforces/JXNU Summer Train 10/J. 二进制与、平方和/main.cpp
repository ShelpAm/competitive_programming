...
/*Judge: Codeforces*/
/*URL: https://codeforces.com/gym/541349/problem/J*/
...
class Segment_tree {
  struct Lazy_tag {
    auto operator+=(Lazy_tag const &rhs) -> Lazy_tag &
    {
      ...
      bitwise_and &= rhs.bitwise_and;
      return *this;
    }

    std::int_fast64_t addition{};
    int bitwise_and{(1 << 31) - 1};
  };
