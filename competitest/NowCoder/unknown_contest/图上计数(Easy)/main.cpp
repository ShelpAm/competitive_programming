...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/86639/K
// Memory Limit: 524288
// Time Limit: 2000
// Start: Wed 17 Jul 2024 01:44:46 PM CST
// Author: ShelpAm
...
public:
  ...
  [[nodiscard]] bool united(int x, int y) { return find(x) == find(y); }
  [[nodiscard]] int size(int x) { return _size[find(x)]; }
