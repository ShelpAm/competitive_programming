...
// Memory Limit: 524288
// Time Limit: 2000
// Start: Wed 17 Jul 2024 04:58:13 PM CST
// Author: ShelpAm
...
auto bellman_ford(Graph const &g, int const src,
                  std::vector<bool> &vis) -> Bellman_ford_result
{
...
void solve_case()
{
  ...
  auto match{graph::maximum_matching(g, n, m)};
  if (match == n) {
    cout << "Yes\n";
  }
  else {
