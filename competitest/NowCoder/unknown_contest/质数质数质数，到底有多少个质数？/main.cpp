// Problem: 质数质数质数，到底有多少个质数？
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81114/G
// Memory Limit: 524288
// Time Limit: 2000
// Start: Tue 28 May 2024 05:44:36 PM CST
// Author: ShelpAm
...
auto solve_case()
{
  ...
  for (int i{}; i != n; ++i) {
    int a, b;
    cin >> a >> b;
    cout << upper_bound(s.primes.begin(), s.primes.end(), b) -
                lower_bound(s.primes.begin(), s.primes.end(), a)
         << '\n';
  }
}
