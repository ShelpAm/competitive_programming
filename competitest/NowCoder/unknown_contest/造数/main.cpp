...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/86639/A
// Memory Limit: 524288
// Time Limit: 2000
// Start: Wed 17 Jul 2024 01:18:54 PM CST
// Author: ShelpAm
...
{
  using namespace std;
  auto calc{[](int n) { return n == 0 ? 0 : msb(n) + __builtin_popcount(n); }};
  int n;
  cin >> n;
  auto res{calc(n >> 1) + calc(n & 1)};
  cout << res;
}
} // namespace
