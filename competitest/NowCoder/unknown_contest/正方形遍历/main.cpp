...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/103786/D
// Start: Sat 08 Mar 2025 03:19:34 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::vector<std::pair<int, int>> path{{n, 0}};
    debug("to", path.back());
    auto x{[&] { return path.back().first; }};
    auto y{[&] { return path.back().second; }};
