// Problem: 爱丽丝，来扫除啦！(Hard Version)
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/84714/E
// Memory Limit: 524288
// Time Limit: 2000
// Start: Tue 04 Jun 2024 01:34:53 PM CST
// Author: ShelpAm
...
auto solve_case()
{
  ...
  for (int i{}; i != n; ++i) {
    ...
    if ((x == 0) != (y == 0)) {
      ...
      auto const d{gcd(abs(x), abs(y))};
      x /= d, y /= d;
    }
    check_max(ans, ++cnt[{x, y}]);
  }
  debug("cnt", cnt);
  cout << ans;
}
