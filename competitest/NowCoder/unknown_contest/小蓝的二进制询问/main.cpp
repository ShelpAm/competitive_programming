...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/86639/D
// Memory Limit: 524288
// Time Limit: 2000
// Start: Wed 17 Jul 2024 02:13:02 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  auto get{[](i64 n) {
    i64 res{};
    for (int i{1}; i <= n; i <<= 1) { // i is half the period.
      res += n / (2 * i) * i;
      auto left{n % (2 * i)};
      res += max(i64{}, left - i);
      res %= mod998244353;
  ...
  u64 l, r;
  cin >> l >> r;
  cout << (get(r + 1) - get(l) + mod998244353) % mod998244353 << '\n';
}
} // namespace
