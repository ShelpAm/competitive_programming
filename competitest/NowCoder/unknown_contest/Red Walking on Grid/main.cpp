// Problem: Red Walking on Grid
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81597/C
// Memory Limit: 1048576
// Time Limit: 4000
// Start: Wed 24 Jul 2024 03:08:40 AM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  for (int i{}; i != n; ++i) {
    ...
    if (a[0][i] == 'R' && a[1][i] == 'R') {
      f = {max(f[1] + 1, f[0]), max(f[0] + 1, f[1])};
    }
    check_max(ans, max(f[0], f[1]));
  }
  check_max(--ans, 0);
  cout << ans;
}
