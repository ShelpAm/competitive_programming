// Problem: 智乃的Chino语言随机数生成器(easy version)
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/78806/B
// Memory Limit: 524288
// Time Limit: 2000
// Start: Sat 27 Apr 2024 02:14:36 PM CST
// Author: ShelpAm
...
auto solve_case() {
  ...
  int p, q;
  cin >> p >> q;
  vector<string> ans{"rand 0", "test 1 0 1", "return 1"};
  cout << ans.size() << '\n';
