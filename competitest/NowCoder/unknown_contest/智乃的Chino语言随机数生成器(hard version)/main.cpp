// Problem: 智乃的Chino语言随机数生成器(hard version)
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/78806/F
// Memory Limit: 524288
// Time Limit: 2000
// Start: Sat 27 Apr 2024 02:26:11 PM CST
// Author: ShelpAm
...
auto solve_case() {
  ...
  if (p > q) {
    for (int i{}; i != q; ++i) {
      ans.push_back("rand " + to_string(i));
    }
    // for (int i{q}; i != p; ++i) {
    //   ans.push_back("test " + to_string(i) + "0 1");
    // }
