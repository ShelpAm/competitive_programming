// Problem: Instructions Substring
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81597/H
// Memory Limit: 524288
// Time Limit: 2000
// Start: Wed 24 Jul 2024 03:31:54 AM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  for (int i{n}; i != -1; --i) {
    idx[a[i]] = i;
    if (idx.count({a[i].first + x, a[i].second + y})) {
      auto j{idx[{a[i].first + x, a[i].second + y}]};
      check_max(j, i + 1);
      ans += n - j + 1;
    }
  }
