...
/*Judge: NowCoder*/
/*URL: https://ac.nowcoder.com/acm/contest/97487/F*/
/*Start: Sat 07 Dec 2024 02:11:25 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
    ...
    int xa, ta, xb, tb;
    std::cin >> xa >> ta >> xb >> tb;
    k *= v; // Scales the velocity.

    bool swapped{};
    int last_state{xa < xb};

    for (int i{}; i != k; ++i) {
        xa += ta;
        xb += tb;

        auto const cur_state{xa < xb};
