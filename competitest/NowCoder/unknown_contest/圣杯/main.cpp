...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/103786/C
// Start: Sat 08 Mar 2025 01:40:16 PM CST
// Author: ShelpAm
...
void solve_case()
{
    int n, p, q;
    std::cin >> n >> p >> q;
    auto const k = 2 * p * q * pow(10000LL, mod1e9p7 - 2, mod1e9p7) % mod1e9p7;
    std::cout << pow(k, n, mod1e9p7) << '\n';
}
} // namespace
