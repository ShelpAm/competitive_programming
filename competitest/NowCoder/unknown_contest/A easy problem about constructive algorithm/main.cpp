// Problem: A easy problem about constructive algorithm
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81249/B
// Memory Limit: 524288
// Time Limit: 2000
// Start: Mon 22 Apr 2024 05:14:24 PM CST
// Author: ShelpAm
...
class disjoint_set_union {
 public:
  explicit disjoint_set_union(std::size_t size): parent_(size), size_(size, 1)
  {
...
auto solve_case()
{
  ...
  for (auto const& [w, u, v]: edges) {
    if (dsu.united(u, v + n) || dsu.united(u + n, v)) {
      cout << w;
      return;
    };
    dsu.unite(u, v + n);
