...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/84851/D
// Memory Limit: 524288
// Time Limit: 2000
// Start: Sun 16 Jun 2024 07:18:46 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  auto f{[&](auto t) {
    auto first{t / 3};
    auto second{ceil(t - 2, 10)};
    auto both{ceil(ceil(t - 2, 10), 3)};
    /*debug("t", t);*/
    /*debug("first second both", vector{first, second, both});*/
    auto bad{first + second - both};
    return t - bad;
  }};
  u64 lo{1}, hi{inf<u64>};
  while (lo < hi) {
