...
/*Judge: NowCoder*/
/*URL: https://ac.nowcoder.com/acm/contest/82345/F*/
/*Start: Fri 27 Sep 2024 11:42:09 AM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  std::vector<int> g(n + 1, inf<int>);
  for (auto const e : a) {
    chmin(*std::ranges::lower_bound(g, e), e);
  }
  std::cout << std::ranges::find(g, inf<int>) - g.begin() << '\n';
}
} // namespace
