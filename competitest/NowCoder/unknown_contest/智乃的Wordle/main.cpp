...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/101918/B
// Start: Fri 14 Feb 2025 07:34:29 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::string r;
    for (auto const [u, v] : std::views::zip(s, t)) {
        if (u == v) {
            r += 'g';
        }
    ...
    std::cout << r << '\n'
              << (std::ranges::count(r, 'g') == r.size() ? "congratulations"
                                                         : "defeat");
}
} // namespace
