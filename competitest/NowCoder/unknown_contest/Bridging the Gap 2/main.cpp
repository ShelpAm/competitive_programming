// Problem: Bridging the Gap 2
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81598/A
// Memory Limit: 2097152
// Time Limit: 2000
// Start: Tue 23 Jul 2024 12:36:56 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  // 当l != 1时，若一个人很厉害，则会溢出；反之，当l ==
  // 1时，他溢出的也可以用上。
  if (l != 1) {
    check_min(cnt, 2 * (cnt - (*max_element(h.begin(), h.end()) - 1) / 2));
  }
  cout << (cnt / l * (r - l) >= n - volunteers ? "Yes" : "No");
}
} // namespace
