// Problem: hasse diagram games
// Contest: unknown_contest
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81249/F
// Memory Limit: 524288
// Time Limit: 2000
// Start: Mon 22 Apr 2024 06:03:26 PM CST
// Author: ShelpAm
...
auto solve_case()
{
  ...
  while (q--) {
    ...
    if (dsu.united(a, b + n) || dsu.united(a + n, b)) {
      cout << "No";
      continue;
    }
    auto const ss{strs[a] + strs[a]};
    if (ss.find(strs[b]) == string::npos) {
      dsu.unite(a, b + n);
      dsu.unite(a + n, b);
    }
    else {
