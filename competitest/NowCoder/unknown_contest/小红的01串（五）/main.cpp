...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/98256/E
// Start: Sun 15 Dec 2024 07:45:10 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    for (int i = s.size() - 1; i != -1; --i) {
        if (s[i] == '?') {
            decltype(f) g;
            std::ranges::rotate_copy(f.begin(), f.begin() + r, f.end(),
                                     g.begin());
            ...
            std::ranges::rotate(f.begin(), f.begin() + r, f.end());
        }
        (r *= 10) %= 13;
    }
