...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/99587/A
// Start: Sat 28 Dec 2024 01:04:52 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::partial_sum(b.begin(), b.end(), sb.begin() + 1);
    for (auto const e : a) {
        auto const p{std::ranges::upper_bound(b, e) - b.begin()};
        ans += (m - p) * e;
        ans += sb[p];
    }
    std::cout << ans << '\n';
