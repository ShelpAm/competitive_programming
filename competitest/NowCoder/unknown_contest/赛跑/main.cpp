...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/84888/B
// Memory Limit: 1048576
// Time Limit: 4000
// Start: Fri 21 Jun 2024 07:06:40 PM CST
// Author: ShelpAm
...
#define int i64
  ...
  for (auto &[x, y] : b) {
    cin >> x >> y;
    check_max(ans, x - y + v3.back());
    check_max(ans, y - x + v1.back());
    check_max(ans, y + x + v4.back());
    check_max(ans, -y - x + v2.back());
  }
  cout << ans;
#undef int
}
