...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/81114/I
// Memory Limit: 524288
// Time Limit: 2000
// Start: Tue 28 May 2024 05:58:15 PM CST
// Author: ShelpAm
...
auto solve_case()
{
  ...
  auto check{[](vector<int>& a) {
    int res{};
    auto const d{a[1] - a[0]};
    for (int i{2}; i != a.size(); ++i) {
      auto const diff_with_d{abs(a[i] - a[i - 1] - d)};
      if (diff_with_d > 1) {
        return -1;
      }
      if (diff_with_d == 1) {
