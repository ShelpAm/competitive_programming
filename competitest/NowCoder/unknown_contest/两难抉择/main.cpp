...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/86639/H
// Memory Limit: 524288
// Time Limit: 2000
// Start: Wed 17 Jul 2024 01:38:07 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  auto s{sum_of(a)};
  s += max(static_cast<i64>(n),
           *max_element(a.begin(), a.end()) * static_cast<i64>(n - 1));
  cout << s;
}
} // namespace
