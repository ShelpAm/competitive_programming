...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/84714/G
// Memory Limit: 524288
// Time Limit: 2000
// Start: Tue 04 Jun 2024 01:30:46 PM CST
// Author: ShelpAm
...
auto solve_case()
{
  ...
  auto check{[&](int const mask) {
    ...
    return string{q.begin(), q.end()} == t;
  }};
  int ans{};
  for (int i{}; i != 1 << t.size(); ++i) {
    ans += check(i);
  }
  cout << ans;
}
