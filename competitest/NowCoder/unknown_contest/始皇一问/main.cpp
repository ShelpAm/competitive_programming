...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/84844/E
// Memory Limit: 1048576
// Time Limit: 2000
// Start: Tue 11 Jun 2024 07:50:21 PM CST
// Author: ShelpAm
...
void solve_case()
{
  ...
  int t;
  cin >> t;
  vector<i64> pinv(5001, 1);
  for (u64 i{2}; i != pinv.size(); ++i) {
    pinv[i] = pinv[i - 1] * pow(i, mod<u64> - 2, mod<u64>) % mod<u64>;
  }
  while (t--) {
    int n, m;
    cin >> n >> m;
