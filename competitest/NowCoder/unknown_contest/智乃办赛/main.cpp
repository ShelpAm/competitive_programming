...
// Judge: NowCoder
// URL: https://ac.nowcoder.com/acm/contest/101918/A
// Start: Fri 14 Feb 2025 07:31:10 PM CST
// Author: ShelpAm
...
void solve_case()
{
    ...
    std::cout << static_cast<char>('A' + (n - 1) / 500) << std::setfill('0')
              << std::setw(3) << (n - 1) % 500 + 1;
}
} // namespace
