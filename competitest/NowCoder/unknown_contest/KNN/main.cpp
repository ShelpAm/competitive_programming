...
/*Judge: NowCoder*/
/*URL: https://ac.nowcoder.com/acm/contest/90505/J*/
/*Start: Thu 24 Oct 2024 07:31:20 PM CST*/
/*Author: ShelpAm*/
...
auto kruskal(Graph const &g)
    -> std::pair<std::int_fast64_t, std::priority_queue<i64>>
{
...
void solve_case()
{
  ...
  int n;
  std::cin >> n;
  Graph g = Graph::read(n, n * (n - 1) / 2, false, true);
