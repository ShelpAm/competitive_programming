/*Problem: AT_abc295_a [ABC295A] Probably English*/
/*Contest: unknown_contest*/
/*Judge: Luogu*/
/*URL: https://www.luogu.com.cn/problem/AT_abc295_a?contestId=200260*/
/*Start: Thu 26 Sep 2024 07:02:32 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  std::set<std::string> const s{"and", "not", "that", "the", "you"};

  std::cout << (std::ranges::any_of(
                    a, [&](auto const &e) { return s.contains(e); })
                    ? "Yes"
                    : "No")
            << '\n';
  /*return;*/
