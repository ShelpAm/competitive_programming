/*Problem: P10810 【MX-S2-T1】变*/
/*Contest: unknown_contest*/
/*Judge: Luogu*/
/*URL: https://www.luogu.com.cn/problem/P10810?contestId=184989*/
/*Start: Mon 29 Jul 2024 08:03:48 PM CST*/
/*Author: ShelpAm*/
...
void solve_case()
{
  ...
  for (int i{1}; i * i <= s.size(); ++i) {
    if (s.size() % i == 0) {
      for (auto const e : {i, static_cast<int>(s.size()) / i}) { // e is period.
        std::vector<std::vector<int>> cnt(26, std::vector<int>(e));
