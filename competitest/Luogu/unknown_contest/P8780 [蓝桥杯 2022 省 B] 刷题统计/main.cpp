// Problem: P8780 [蓝桥杯 2022 省 B] 刷题统计
// Contest: unknown_contest
// Judge: Luogu
// URL: https://www.luogu.com.cn/problem/P8780?contestId=171012
// Memory Limit: 128
// Time Limit: 1000
...
auto solve_case()
{
  ...
  i64 a, b, n;
  cin >> a >> b >> n;
  auto const perweek{a * 5 + b * 2};
  auto const weeks{n / perweek};
  i64 days{};
  auto const remainder{n % perweek};
  if (remainder <= 5 * a) {
    days += (remainder + a - 1) / a;
  }
  else {
    days += (remainder - 5 * a + b - 1) / b + 5;
  }
  cout << weeks * 7 + days;
}
