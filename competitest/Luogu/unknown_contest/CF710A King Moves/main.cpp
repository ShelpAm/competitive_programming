/*Problem: CF710A King Moves*/
/*Contest: unknown_contest*/
/*Judge: Luogu*/
/*URL: https://www.luogu.com.cn/problem/CF710A?contestId=200260*/
...
void solve_case()
{
  ...
  std::set<std::string> corner{"a1", "a8", "h1", "h8"};
  ...
  if ((std::string{"ah"}.contains(p[0])) ||
      (std::string{"18"}.contains(p[1]))) {
    std::cout << 5 << '\n';
    return;
  }
