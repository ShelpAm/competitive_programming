// Problem: P8611 [蓝桥杯 2014 省 AB] 蚂蚁感冒
// Contest: unknown_contest
// Judge: Luogu
// URL: https://www.luogu.com.cn/problem/P8611?contestId=171012
// Memory Limit: 128
// Time Limit: 1000
...
auto solve_case()
{
  ...
  vector<int> a(n);
  cin >> a;
  auto const first{abs(a.front())};
  sort(a.begin(), a.end());
  // debug("a", a);
  auto const ans{upper_bound(a.begin(), a.end(), -first) - a.begin() +
                 upper_bound(a.begin(), a.end(), first) -
