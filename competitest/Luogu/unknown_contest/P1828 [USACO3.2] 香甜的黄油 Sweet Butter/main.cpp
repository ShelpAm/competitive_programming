// Problem: P1828 [USACO3.2] 香甜的黄油 Sweet Butter
// Contest: unknown_contest
// Judge: Luogu
// URL: https://www.luogu.com.cn/problem/P1828
// Memory Limit: 128
// Time Limit: 1000
// Start: Sun 12 May 2024 08:48:50 PM CST
// Author: ShelpAm
...
auto solve_case()
{
  ...
  vector<int> pos(n);
  cin >> pos;
  auto const g{graph::read_graph(p, c, true, true, true)};
  u64 ans{inf<u64>};
  for (int i{}; i != p; ++i) {
    auto const dis{graph::bellman_ford(g, i).distance};
    u64 s{};
