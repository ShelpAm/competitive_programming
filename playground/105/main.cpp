...
void solve_case()
{
  ...
  for (int i{}; i != 2 * n; ++i) {
    ...
    if (x == -1) {
      (ans *= cnt.begin()->second--) %= mod998244353;
      (inv *= pow(o--, mod998244353 - 2, mod998244353)) %= mod998244353;
      if (cnt.begin()->first < last) {
        ans *= 0;
      }
      last = cnt.begin()->first;
