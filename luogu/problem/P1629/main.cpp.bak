...
static inline auto solve_case()
{
  ...
  for (size_t i{}; i != m; ++i) {
    ...
    r[v].emplace_back(w, u);
  }
  vec1<size_t> cost(n), to_origin(n);
  auto calc{[](auto&& g, auto&& cost) {
    unordered_set<size_t> points;
