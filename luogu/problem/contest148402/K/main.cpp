...
bool contains(std::string_view const a, std::string_view const b)
{
  for (size_t i{}; i + b.size() - 1 < a.size(); ++i) {
...
void solve_case()
{
  ...
  auto trans{[](std::string& s) { s = s.substr(1) + s.front(); }};
