...
static auto solve_case()
{
  ...
  u64 cnt{};
  for (__int128_t i{0}; i != 33; ++i) {
    auto const ii{qpow(2, i)};
    if (ii > r) {
      break;
    }
    for (__int128_t j{0}; j != 33; ++j) {
      auto const jj{qpow(3, j)};
      if (ii * jj > r) {
        break;
      }
      for (__int128_t k{0}; k != 33; ++k) {
        auto const kk{qpow(5, k)};
        if (ii * jj * kk > r) {
          break;
        }
        for (__int128_t t{0}; t != 33; ++t) {
          auto const ll{qpow(7, t)};
          auto const res{ii * jj * kk * ll};
          if (res > r) {
            break;
          }
          if (res >= l) {
